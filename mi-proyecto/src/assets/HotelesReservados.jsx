...
export default function HotelesReservados () {
            ...
            <Table>
              ...
              <TableBody>
                {paquetes.map(paquetes => (
                  <TableRow key={paquetes.id_cliente}>
                    <TableCell>{paquetes.nombre}</TableCell>
                    <TableCell>{paquetes.apellidos}</TableCell>
                    <TableCell>{paquetes.paquete_nombre}</TableCell>
                    <TableCell>{paquetes.paquete_fecha}</TableCell>
                    <TableCell>{paquetes.paquete_costo}</TableCell>
                    <TableCell>{paquetes.pais}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
